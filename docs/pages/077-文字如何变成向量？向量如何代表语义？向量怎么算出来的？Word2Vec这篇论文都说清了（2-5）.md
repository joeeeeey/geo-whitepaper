---
layout: article
title: 文字如何变成向量？向量如何代表语义？向量怎么算出来的？Word2Vec这篇论文都说清了（2-5）
permalink: /pages/077-文字如何变成向量？向量如何代表语义？向量怎么算出来的？Word2Vec这篇论文都说清了（2-5）/
page_num: 77
section_id: '06'
section_name: 案例与参考
...
word_count: 5243
is_featured: false
prev_url: /pages/076-文字如何变成向量？向量如何代表语义？向量怎么算出来的？Word2Vec这篇论文都说清了（1-5）/
prev_title: 文字如何变成向量？向量如何代表语义？向量怎么算出来的？Word2Vec这篇论文都说清了（1-5）
next_url: /pages/078-文字如何变成向量？向量如何代表语义？向量怎么算出来的？Word2Vec这篇论文都说清了（3-5）/
next_title: 文字如何变成向量？向量如何代表语义？向量怎么算出来的？Word2Vec这篇论文都说清了（3-5）
---
